...
j^\dagger_\mu\,\eta^{\mu\nu}\,j_\nu$ yields the tree-level matching 
condition
\begin{equation}\label{eq:GF_matching}
    \frac{G_F}{\sqrt{2}} \sim \frac{g^2}{M_W^2},
\end{equation}
