...
\begin{align}\nonumber
    ...
    &= - \frac{g}{\cos\theta_W}\bar{\psi}_f\frac{\gamma^\mu}{2}\left(T^3_f - Q\_fsin^2\theta_W\right)(1+1+\gamma^5-\gamma^5)\psi_f\, Z_\mu\\\nonumber
...
\begin{equation}\label{eq:gvandga}
    ...
    \end{cases}.
\end{equation}
Its worth noting that the presence of the $Q_{f}\sin^{2}\theta_{W}$ term of $g^f_V$ in \ref{eq:gvandga} is what prevents the $Z$ boson interaction to be maximally $\mathcal{P}$-violating.